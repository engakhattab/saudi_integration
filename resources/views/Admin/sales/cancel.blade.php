...
@section('title') {{$setting->title}} | Family Cancel @endsection
@section('page_name') Family Cancel @endsection
@section('css')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{$setting->title}} Family Cancel</h3>
                    <div class="">
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">Cancel Ticket</th>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" id="delete_btn">Cancel Ticket !</button>
                        </div>
                    </div>
                </div>
            </div>
