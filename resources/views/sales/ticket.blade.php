                ...
                <div class=" bill" id="bill">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            ...
                            <li><label> الرقم الضريبي : </label> <strong>311416936900003</strong></li>
                            <li><label> 311416936900003 : </label> <strong>Vat Reg No</strong></li>
                            <li><label> Customer phone : </label> <strong >{{$client->phone}}</strong></li>
...
{{--                    </div>--}}
                    <div id="printDiv" style="display: none">
                        <div class="printBtn">
                         ...
                         <div class="printBtn"> <!-- Added margin-top for spacing -->
        <a class="btn btn-success" target="_blank" id="whatsappBtn">
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data.status == true){
                            ...
                            $('#lastPrev').hide();
                            $('#printDiv').show();
                             whats_ticket_no=data.printUrl.match(/ticket\/(\d+)/)[1];
                             $pdfurl  = data.printUrl.replace(/edit/g, "pdf");
